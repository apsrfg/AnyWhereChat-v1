...
public class ChatController {
    ...
    private synchronized void setState(int state) {
        ...
        handler.obtainMessage(DevicesActivity.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        Message msg = handler.obtainMessage(DevicesActivity.MESSAGE_DEVICE_OBJECT);
        Bundle bundle = new Bundle();
        bundle.putParcelable(DevicesActivity.DEVICE_OBJECT, device);
        msg.setData(bundle);
    ...
    private void connectionFailed() {
        Message msg = handler.obtainMessage(DevicesActivity.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
